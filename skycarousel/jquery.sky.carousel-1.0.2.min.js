...
SKY.ImageLoader.prototype = {
    ...
    unsubscribe: function(a) {
        for (var b = 0; b < this.subscribers.length; b++)
            this.subscribers[b] === a && delete this.subscribers[b]
    },
    publish: function() {
        if (!this.fired) {
            this.fired=!0;
            for (var a = 0; a < this.subscribers.length; a++)
                if ("function" === typeof this.subscribers[a])
                    this.subscribers[a]()
        }
    },
    load: function() {
...
SKY.Timer.prototype = {
    ...
    publish: function(a) {
        for (var b = 0; b < this.subscribers.length; b++)
            if ("function" === typeof this.subscribers[b])
                this.subscribers[b](a)
    },
    reset: function() {
        this.currentCount = 0
    },
...
SKY.CarouselItem.prototype = {
    ...
    unsubscribe: function(a, b) {
        for (var c = 0; c < this.subscribers[a].length; c++)
            this.subscribers[a][c] === b && delete this.subscribers[a][c]
    },
    publish: function(a, b) {
        for (var c = 0; c < this.subscribers[a].length; c++)
            if ("function" === typeof this.subscribers[a][c])
                this.subscribers[a][c](b)
    },
    index: function() {
    ...
    onImageLoaded: function() {
        ...
        a.reflectionSize, a.reflectionAlpha), this.reflection.css({
            "float" : "left", clear : "both", "margin-top" : a.reflectionDistance + "px"
    ...
    update: function() {
        ...
        if (SKY.Utils.has2dTransformationSupport())
            a =
            "translate(" + this.x + "px, " + this.y + "px) scale(" + this.scale + ")", SKY.Utils.has3dTransformationSupport() && (a += " translateZ(0)"), this.element.css(SKY.Utils.getPrefixedProperty("transform"), a), this.element.css("opacity", 0.6);
        else {
            ...
            a.reflectionVisible&&!SKY.Utils.hasCanvasSupport() ? (c.opacity = this.alpha, this.reflection && this.reflection.css({
                width : b.width, height : b.height, filter : SKY.CarouselItem.getAlphaFilterStatement(a.reflectionAlpha, a.reflectionSize, a.itemHeight)
...
SKY.Carousel.prototype = {
    ...
    initKeyboardNavigation: function() {
        ...
        s.enableKeyboard && this.dom.document.keydown(function(b) {
            if ("textarea" != b.target.type && "text" != b.target.type)
                switch (b.keyCode) {
                case 40:
    ...
    update: function() {
        ...
        d = c.getLeft(), g = [], e = 0; e < this.carouselItems.length; e++) {
            ...
            if (k <= b.motionStartDistance)
                var p = this.calculateAlpha(k), l = this.calculateScale(k), n = this.calculateExtraDistance(k);
            else 
                p = b.unselectedItemAlpha, l = b.unselectedItemZoomFactor, n = 0;
    ...
    onStart: function(a) {
        ...
        if ("A" != a.target.nodeName) {
            ...
            if (this.events.touchCancel)
                this.dom.document.on(this.events.touchCancel, c);
...
window.Modernizr = function(a, b, c) {
    ...
    b.createElement("modernizr"), p = k.style, l = " -webkit- -moz- -o- -ms- ".split(" "), n = ["Webkit", "Moz", "O", "ms"], m = ["webkit", "moz", "o", "ms"], k = {}, t = [], q = t.slice, u, w = function(a, c, d, e) {
        ...
        if (parseInt(d, 10))
            for (; d--;)
                k = b.createElement("div"), k.id = e ? e[d] : "modernizr" + (d + 1), l.appendChild(k);
    ...
    for (var y in k)
        v(k, y) && (u = y.toLowerCase(), f[u] = k[y](), t.push((f[u] ? "" : "no-") + u));
    f.addTest = function(a, b) {
        if ("object" == typeof a)
            for (var d in a)
                v(a, d) && f.addTest(d, a[d]);
        else {
            a = a.toLowerCase();
            if (f[a] !== c)
                return f;
